<html>
    ...
    {
    alert("Informe o nome completo da Cidade/Município/Distrito/Povoado. Para o DF poderá ser informado o nome da Regiío Administrativa (Lago Sul, Lago Norte, Cruzeiro, Taguatinga, etc) !!");
													  ...
													  <table border="0" cellspacing="1" cellpadding="5">
  														<form name="Geral" method="post" onSubmit="return CriticaCampos();" action="http://www.buscacep.correios.com.br/servicos/dnec/consultaLogradouroAction.do"  target="_blank">
																...
																<tr> 
																	...
																	<option value="Praçaa">Praçaa</option>
